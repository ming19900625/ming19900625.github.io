window.onload = () => {
    ...
    var input: HTMLInputElement = <HTMLInputElement>document.getElementById("inputValue");
    var btn: HTMLButtonElement = <HTMLButtonElement>document.getElementById("btn");
    var resultCount: HTMLLabelElement = <HTMLLabelElement>document.getElementById("resultCount");
    var allResult: HTMLTextAreaElement = <HTMLTextAreaElement>document.getElementById("allResult");
    var i = 0;
    btn.onclick = () => {
        var length: number = parseInt(input.value);
        ...
        setTimeout(() => {
            try {
                ...
                var chessBoard: ChessBoard1 = new ChessBoard1(length);
                var result: Array<Array<number>> = chessBoard.getResult;
