 ...
 * 棋盘，可自定义长度
 */
var ChessBoard1 = (function () {
    /**
     * 创建一个棋盘
     * @param length 棋盘的大小 length * length
     */
    function ChessBoard1(length) {
        if (length <= 3) {
     ...
     */
    ChessBoard1.prototype.curMoveIsFine = function () {
        //取到最后一步走的行数
    ...
    ChessBoard1.prototype.cloneResult = function (values) {
    ...
    ChessBoard1.prototype.move = function () {
        var _this = this;
        function forward() {
            _this.curMoveY++;
            //如果超出棋盘，结束
    ...
    Object.defineProperty(ChessBoard1.prototype, "getResult", {
        get: function () {
            this.move();
...
//# sourceMappingURL=chessboard1.js.map