...
var Program = (function () {
    function Program() {
        var _this = this;
        this.drawCylinder = function (cylinder) {
            var testVertexCode = '\
        ...
        this.download = function () {
            var materialName = "test.mtl";
            var picName = "11.jpg";
            var image = new Image();
            image.src = '../images/11.jpg';
            FileHelper.SaveFile(picName, '../images/11.jpg');
            FileHelper.SaveStringFile(materialName, _this.cylinder.getMaterialStr(picName));
            FileHelper.SaveStringFile("cylinder.obj", _this.cylinder.getString(materialName));
        };
        this.upload = function () {
            var that = _this;
            var files = _this.uploadFilesInput.files;
        ...
        this.drawModel = function (model, imgPath) {
            var testVertexCode = '\
            attribute vec3 aVertexPosition;\
            attribute vec2 mp;\
            attribute vec3 normal;\
        ...
        this.fragInput = document.getElementById("fragInput");
        this.drawCylinderBtn = document.getElementById("drawCylinderBtn");
        this.drawCylinderBtn.onclick = function () {
            var fragNum = parseInt(_this.fragInput.value);
            _this.cylinder = new Cylinder(fragNum, 2);
            _this.drawCylinder(_this.cylinder);
        };
        this.downloadBtn = document.getElementById("downloadBtn");
        this.downloadBtn.onclick = function () {
            if (_this.cylinder == null) {
                alert("请先画出圆柱体");
                return;
            }
            _this.download();
        };
        this.uploadFilesInput = document.getElementById("file");
        this.drawModelBtn = document.getElementById("drawModelBtn");
        this.drawModelBtn.onclick = function () {
            _this.upload();
        };
    }
    Program.prototype.tryDraw = function () {
        if (this.mod == null)
            return;
